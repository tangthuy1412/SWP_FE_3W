  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#f7f8f5] text-[#252824]">
      <nav className="relative z-20 mx-auto flex h-20 max-w-7xl items-center justify-between px-5 md:px-8">
        <Link to="/" className="flex items-center gap-3" aria-label="Aether home">
          ...
          <span className="text-xl font-bold tracking-[-0.045em]">Aether<span className="text-[#d47a3c]">.</span></span>
        </Link>
